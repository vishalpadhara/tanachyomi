        ...
        children: [
          Text(
              RegExp(r'((^0*[1-9]\d*:)?\d{2}:\d{2})\.\d+$')
                  ...
                  ?.group(1) ??
                  '$_position',
              style: TextStyle(color: AppColor.white)/*Theme.of(context).textTheme.caption*/),
          Expanded(
            flex: 1,
            child: Stack(
              children: [
                ...
                SliderTheme(
                  data: _sliderThemeData.copyWith(
                    // inactiveTrackColor: Colors.transparent,
                     activeTrackColor: AppColor.appColorSecondaryValue,
                ...
                //           ?.group(1) ??
                //           '$_position',
                //       style: TextStyle(color: Colors.red)/*Theme.of(context).textTheme.caption*/),
                // ),
                // Positioned(
                //   right: 16.0,
                //   bottom: 0.0,
