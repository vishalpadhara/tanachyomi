...
//
//     final newUserInfoModel = newUserInfoModelFromJson(jsonString);

import 'dart:convert';

NewUserInfoModel newUserInfoModelFromJson(String str) =>
    NewUserInfoModel.fromJson(json.decode(str));

String newUserInfoModelToJson(NewUserInfoModel data) =>
...
class NewUserInfoModel {
  ...
  factory NewUserInfoModel.fromJson(Map json) => NewUserInfoModel(
        id: json["Id"],
